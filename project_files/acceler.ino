...
#define BLYNK_DEVICE_NAME "my projectCopy"
...
char ssid[] = "xxxxxxx";//Enter your WIFI name
...
Blynk.email("e17045@eng.pdn.ac.lk", "Alert : Fall Detected…!", "Alert : Fall Detected…! take action immediately.");     
fall = false;   
}   
...
while (millis()<starttime+4000)                   // Reading pulse sensor for 10 seconds
